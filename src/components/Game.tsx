        ...
        <div id="game-container" className="flex flex-col">
            <div className="mb-2 w-fit select-none">
                <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 px-2">
                    {Object.entries(GAME_PRESETS).map(([presetName, presetParams]) => (
                        <div
                        ...
                        >
                            ...
                            <input
                                ...
                                onChange={() =>
                                    game.reset({
                                        navigate,
                                        presetName: presetName as GamePresetName,
                    ...
                    <button
                        ...
                        className={twJoin(game.presetName === 'custom' && 'font-bold')}
                    >
                        ...
                        <ExpandMoreIcon
                            ...
                            className={twJoin(settingsExpanded && 'rotate-[180deg]')}
                        />
                    </button>
                </div>
            </div>
